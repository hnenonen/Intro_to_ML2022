...
def magic(models, classtype):
  ...
  X_train, X_test, y_train, y_test = train_test_split(
      X, y, train_size=0.8, random_state=38, shuffle=True, stratify=y
  )
  ...
  res["test_perplexity"]= np.append(list, 0)
...
knitr::kable(results_class2, row.names = TRUE, digits = 2)
knitr::kable(results_class4, row.names = TRUE, digits = 2)
```
